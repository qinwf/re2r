...
microbenchmark(quote_meta(dd),quote_meta(dd,parallel = T),times = 5)
```
...
gc()
microbenchmark(re2_replace(dd, regexp, ""), re2_replace(dd, regexp, "", parallel = T) ,times = 5)
gc()
microbenchmark(re2_replace(dd, regexp, "", all = T), re2_replace(dd, regexp, "", all =T, parallel = T) ,times = 5)
```
