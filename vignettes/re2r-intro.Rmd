...
```{r}
re2_match("this is just one test", "(o.e)")
```
...
```{r}
(res = re2_match("this is just one test", "(o.e)",value = TRUE))
str(res)
```
...
```{r}
(res = re2_match("this is just one test", "(?P<testname>this)( is)", value = TRUE))
str(res)
```
...
```{r}
(res = re2_match("this is just one test", "(is)", value = TRUE, all = TRUE))
str(res)
```
