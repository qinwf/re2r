...
cpp_locate <- function(input, regexp, all, parallel) {
    .Call('re2r_cpp_locate', PACKAGE = 're2r', input, regexp, all, parallel)
}

cpp_match <- function(input, ptr, value, anchor, all, parallel) {
    .Call('re2r_cpp_match', PACKAGE = 're2r', input, ptr, value, anchor, all, parallel)
}

cpp_split <- function(input, ptr, part, fixed, parallel) {
    .Call('re2r_cpp_split', PACKAGE = 're2r', input, ptr, part, fixed, parallel)
}
...
cpp_extract <- function(input, regexp, all, parallel) {
    .Call('re2r_cpp_extract', PACKAGE = 're2r', input, regexp, all, parallel)
}
