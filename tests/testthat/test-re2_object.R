...
test_that("other RE2 object tests",{
    ...
    expect_output(print(re2("abc")),"re2 pre-compiled regular expression.*pattern: abc.*number of capturing subpatterns: 0.*capturing names with indices:.*expression size:")
})
