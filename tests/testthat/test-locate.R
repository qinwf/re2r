...
test_that("re2_locate", {
    expect_identical(re2_plocate_all(c(NA, "sd"), "sd"), list(
        structure(
    ...
    expect_identical(re2_locate_all(c(NA, "sd"), "sd"),
                     re2_plocate_all(c(NA, "sd"), "sd", grain_size = 1))

    expect_identical(re2_locate(c(NA, "sd"), "sd"),
                     structure(
                         c(NA, 1L, NA, 2L),
                         .Dim = c(2L, 2L),
                         .Dimnames = list(NULL, c("start", "end"))
...
test_that("test locate NA", {
    # NULL
    expect_identical(re2_locate(NULL, pattern = "sd"),
                     structure(
                         integer(0),
                         .Dim = c(0L, 2L),
                         .Dimnames = list(NULL, c("start", "end"))
    ...
    expect_identical(re2_locate_all(c("as", "as", NA), pattern = "sd"),
                     list(
                         structure(
                             integer(0),
                             .Dim = c(0L, 2L),
...
test_that("test locate empty string", {
    # NULL
    expect_identical(re2_locate(NULL, pattern = ""),
                     structure(
                         integer(0),
                         .Dim = c(0L, 2L),
                         .Dimnames = list(NULL, c("start", "end"))
